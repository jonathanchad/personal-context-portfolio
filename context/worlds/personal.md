...
- **Ithaca Creek State School P&C** — Jonathan is on the executive
  (title *unconfirmed*; meeting summaries show him owning bank-account
  changes, the Stripe move, the icsspandc.com site launch, the parent
  survey and event run sheets). Anything for the P&C — website copy,
  newsletters, meeting notices, decisions — goes through the
