...
Who Jonathan actually works with, by organisation, tagged with the worlds
they touch. Built 5 Sep 2026 from the last 60 days of calendar, Granola
meetings and sent mail, plus the Notion Contacts/Organisations databases
and the Charlotte outreach sheet. Frequency = how often they showed up.

**Canonical CRM:** Notion **👤 Contacts** (data source
`301904d0-5b2e-4f7b-a86b-c19edf5c6ace`) and **Organisations**
(`e51e1250-24c1-43b8-80fe-e7e9ccc733bd`). This file is the working set,
not the whole address book. Roles marked *?* are inferred — correct them.

Worlds: **CH** Charlotte · **BT** Breakthrough Tools · **CO** Consulting ·
**P** Personal/P&C.

## Boundless Earth — funder of Charlotte and the "BE" campaigns  [CH · CO]

| Person | Role | Contact | Note |
|---|---|---|---|
| Nicky Ison | Head of Direct Advocacy | nicky.ison@boundless.earth | Main counterparty: Charlotte proposal, electricity/coal budget, Solar Dividend, RISE Collective. Very frequent. |
...
## Gas tax / diesel coalition ("Electricity Epic", "Climate Economics Epic") — Boundless-funded  [CO]

Fortnightly "Diesel Group" and "gas tax core strategy" meetings.

| Org | People |
|---|---|
| CANA (Climate Action Network Australia) / Solutions for Climate | Barry Traill (Solutions for Climate), Michelle Grady, Sophia, Leigh, Kirsti, Madeleine Achenza, Jessica Panegyres, Harvey, Annette, Elly, Cristina, Erin, Manisha, Luke — Jonathan also runs "[Breakthrough AI] Foundation Sessions" for this team |
...
| Farmers for Climate Action | Verity, Caleb |
| Climate Integrity | Bronwyn, Claire |
| IGCC | Michael Bones, Francesca Muskovic, Richard Proudlove, Dani Siew |
...
Boundless campaign (Dione). Weekly WIP with **Gather Media** — Sam, Charlie
Freestone.

## Clients, partners and prospects  [CO · BT]
...
| Benedictus Media | Phil Benedictus, Kelsey | OPPO report recipient |
...
Family is in `worlds/personal.md`, deliberately not here.
